...
interaction-Hug-name = Послать нахуй
interaction-Hug-description = Потому что вы можете.
interaction-Hug-success-self-popup = Вы посылаете нахуй { $target }.
interaction-Hug-success-target-popup = { $user } посылает вас нахуй.
interaction-Hug-success-others-popup = { $user } посылает нахуй { $target }.
