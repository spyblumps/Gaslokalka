...
doc-text-printer-sentence =
    ...
    Я, :ФИО:, в должности :ДОЛЖНОСТЬ:, выношу приговор согласно данным мне полномочиям в отношении :НАРУШИТЕЛЬ:, в должности :ДОЛЖНОСТЬ_НАРУШИТЕЛЯ:.
    ...
    Срок заключения под стражу отсчитывается с: :НАЧАЛО_СРОКА:
    =============================================
                                ⠀[italic]Место для печатей[/italic]
