...
signal-port-name-nuclear-reactor-receiver-insert = Ввод стержней
signal-port-description-nuclear-reactor-receiver-insert = Увеличивает уровень погружения стержней управления.

signal-port-name-nuclear-reactor-receiver-retract = Извлечение стержней
signal-port-description-nuclear-reactor-receiver-retract = Уменьшает уровень погружения стержней управления.
