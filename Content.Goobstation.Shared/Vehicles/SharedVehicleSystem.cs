...
using Content.Shared.Gravity; // CorvaxGoob
...
public abstract partial class SharedVehicleSystem : EntitySystem
{
    ...
    [Dependency] private readonly SharedGravitySystem _gravity = default!; // CorvaxGoob
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<VehicleComponent, RefreshWeightlessModifiersEvent>(OnRefreshWeightlessModifiers); // CorvaxGoob
    }

    private void OnInit(EntityUid uid, VehicleComponent component, ComponentInit args)
    {
        EnsureComp<GravityAffectedComponent>(uid); // CorvaxGoob
        _gravity.RefreshWeightless(uid); // CorvaxGoob
