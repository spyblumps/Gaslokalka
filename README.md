...
## Особые условия для форка и модификаций
Данный репозиторий является форком, для использования любого контента который как либо отличается от основной сборки вам необходимо повторить какой либо мемный момент из фильма "Зелёный Слоник" от Светланы Басковой и прислать видеозапись владельцу форка.
Если вы не знаете какой момент выбрать - танцуйте цаплю. Без предоставления видеозаписи использование контента считается нелегальным и нарушает авторские права.
