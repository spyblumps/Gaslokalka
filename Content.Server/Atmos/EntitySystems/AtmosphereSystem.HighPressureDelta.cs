...
// CorvaxGoob-wind весь файл просто переписываю на ванильный без EE решений, губы всёровно ими не пользуются и отказались ранее, не надо создавать себе проблемы на ровном месте.
using Content.Server.Atmos.Components;
using Content.Shared.Atmos;
using Content.Shared.Atmos.Components;
