...
public sealed class TurbineSystem : SharedTurbineSystem
{
    ...
    private readonly List<string> _damageSoundList = [
        "/Audio/_CorvaxGoob/Effects/engine_grump1.ogg",
        "/Audio/_CorvaxGoob/Effects/engine_grump2.ogg",
        "/Audio/_CorvaxGoob/Effects/engine_grump3.ogg",
    ...
    private void OnInit(EntityUid uid, TurbineComponent comp, ref MapInitEvent args)
    {
        ...
        _ambientSoundSystem.SetSound(comp.AlarmAudioUnderspeed.Value, new SoundPathSpecifier("/Audio/_CorvaxGoob/Machines/alarm_beep.ogg"));
    ...
    private void OnUpdate(EntityUid uid, TurbineComponent comp, ref AtmosDeviceUpdateEvent args)
    {
        ...
        if (!comp.Ruined && AirContents != null)
        {
            ...
            if (comp.RPM > 10)
            {
                ...
                _audio.PlayPvs(new SoundPathSpecifier("/Audio/_CorvaxGoob/Ambience/Objects/turbine_room.ogg"), uid, AudioParams.Default.WithPitchScale(comp.RPM / comp.BestRPM).WithVolume(-2));
            }
